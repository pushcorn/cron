...
test.object ("cron.Job")
    ...
    .should ("parse the expression and return an instance of Job")
        ...
        .expectingPropertyToBe ("result.timezone.name", TZ_TAIPEI)
        .commit ()
;
...
test.method ("cron.Job", "next")
    .should ("handle hash syntax")
        ...
        .given (nit.Date ("2024-08-07 00:00:00", TZ_INDIANAPOLIS))
        .returns (nit.Date ("2024-08-07 14:49:00", TZ_INDIANAPOLIS))
        .expectingExprToReturnValue ("object.timeUntilNextRunHumanized", "14 hours and 49 minutes")
        .expectingMethodToReturnValue ("object.next", null, nit.Date ("2024-08-08 14:49:00", TZ_INDIANAPOLIS))
        .expectingExprToReturnValue ("object.timeUntilNextRunHumanized", "1 day")
        .expectingMethodToReturnValue ("object.next", null, nit.Date ("2024-08-09 14:49:00", TZ_INDIANAPOLIS))
        .commit ()
;
