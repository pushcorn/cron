...
test.method ("cron.Job", "next")
    .should ("handle hash syntax")
        ...
        .given (nit.Date ("2024-08-07 00:00:00", TZ_INDIANAPOLIS))
        .returns (nit.Date ("2024-08-07 00:17:00", TZ_INDIANAPOLIS))
        .expectingExprToReturnValue ("object.timeUntilNextRunHumanized", "17 minutes")
        .expectingMethodToReturnValue ("object.next", null, nit.Date ("2024-08-08 00:17:00", TZ_INDIANAPOLIS))
        .expectingExprToReturnValue ("object.timeUntilNextRunHumanized", "1 day")
        .expectingMethodToReturnValue ("object.next", null, nit.Date ("2024-08-09 00:17:00", TZ_INDIANAPOLIS))
        .commit ()
;
